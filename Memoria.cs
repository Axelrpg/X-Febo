...
namespace X_Febo
{
    public partial class Memoria : Form
    {
        ...
        Clases.MemoriaConexion memoriaConexion = new Clases.MemoriaConexion();

        public Memoria()
        {
            InitializeComponent();
            memoriaConexion.mostrarTabla(dtgvMemoria);
        }
        ...
        private void btnDetener_Click(object sender, EventArgs e)
        {
            ...
            generalConexion.añadirFila(txtNombre.Text, "Memoria");
            memoriaConexion.añadirFila(txtNombre.Text, lblTiempo.Text);
            memoriaConexion.mostrarTabla(dtgvMemoria);
