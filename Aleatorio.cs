...
namespace X_Febo
{
    public partial class Aleatorio : Form
    {
        ...
        Clases.AleatorioConexion aleatorioConexion = new Clases.AleatorioConexion();

        public Aleatorio()
        {
            InitializeComponent();
            aleatorioConexion.mostrarTabla(dtgvAleatorio);
        }
        ...
        private void btnDetener_Click(object sender, EventArgs e)
        {
            ...
            generalConexion.añadirFila(txtNombre.Text, "Aleatorio");
            aleatorioConexion.añadirFila(txtNombre.Text, lblTiempo.Text);
            aleatorioConexion.mostrarTabla(dtgvAleatorio);
